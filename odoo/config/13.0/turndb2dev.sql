...
/*if-table-exists fetchmail_server */update ir_mail_server set is_ssl=false, smtp_host='${TEST_MAIL_HOST}', smtp_user=null, smtp_pass=null, smtp_encryption='none', smtp_port=${TEST_MAIL_SMTP_PORT};
